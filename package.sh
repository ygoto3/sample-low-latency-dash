mkdir -p package
rm -rf package/*
mkdir -p package/0 package/1 package/2

ffmpeg -f flv -listen 1 \
  -i rtmp://0.0.0.0:1935/live/ll-dash \
  -c:a aac \
